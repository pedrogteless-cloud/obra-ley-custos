...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Custos da Obra · Grupo Ley" },
      { name: "description", content: "Controle interno de gastos da reconstrução da fábrica em Eusébio-CE." },
      { name: "author", content: "Grupo Ley" },
      { property: "og:title", content: "Custos da Obra · Grupo Ley" },
